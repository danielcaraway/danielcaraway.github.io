---
layout: single
title: 'How to use Data Science Superpowers for Useless Things: Organizing Ancient Projects Pt 4'
tags: howto portfolio python EHD
---

```python
import os
directory_in_str = '/Volumes/EHD_5/____FIRST_TRANSFER_ALL/'
count = 0
...
#             shutil.move(filepath, newpath)
            ...
            print(file)
#             newpath = destination + '_____OTHER_UNKNOWN/' + file
#             shutil.move(filepath, newpath)

# CHECK TO MAKE SURE ALL ARE GONE
import os
directory_in_str = '/Volumes/EHD_5/____FIRST_TRANSFER_ALL/'
for subdir, dirs, files in os.walk(directory_in_str):
    for file in files:
...
## CREATE YOUR OWN DICT WITH A SHORTHAND
...
### CONVERT THAT SHORTHAND

```python
new_dict = input_dict2
